...
module: Job
updated: 2026-09-01
qmd: "tabella filament resource table class getTableFilters XotBaseResourceTable HasXotTable list page job"
---
...
```php
namespace Modules\Job\Filament\Resources\FooResource\Tables;
