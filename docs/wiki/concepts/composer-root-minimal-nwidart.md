...
Dipendenze del dominio **Job** in `Modules/Job/composer.json`. Il root `laravel/composer.json` resta skeleton come [base_ptvx_fila5](https://github.com/laraxot/platform/blob/dev/laravel/composer.json).
